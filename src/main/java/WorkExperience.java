...
//	LocalDate endDate;
	...
	public WorkExperience(String title, String description, Company company) // if gets more complex, consider using factory pattern?
	{
		...
		links.get("companies").add(new Link(company.getPage(), Link.RelationshipType.FROM_COMPANY));
